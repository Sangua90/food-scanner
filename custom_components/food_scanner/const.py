...
CONF_FOOD_LOW_STOCK_THRESHOLD = "food_low_stock_threshold"
CONF_CONSUMABLE_LOW_STOCK_THRESHOLD = "consumable_low_stock_threshold"
...
DEFAULT_FOOD_LOW_STOCK_THRESHOLD = 3
DEFAULT_CONSUMABLE_LOW_STOCK_THRESHOLD = 2
