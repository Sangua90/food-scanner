...
product_name, brand, quantity, barcode, category, unit_name, units_per_package, confidence.
Regole:
...
- Non inventare barcode o quantità non leggibili.
- confidence è 0-100.
"""
    ...
    async def post(self, request):
        ...
        try:
            ...
            if action == "scan":
                ...
                return self.json({"success": True, "item": item, "detected": detected, "new_product": created})
